...
This konnector fetch all bills and order data from your [LDLC](https://ldlc.com) account.

* Create io.bozy.bills documents for each order in your account
* Download invoice PDF documents if availables

An object is created in memory with precise details of each order. It is not saved anywhere yet.
...
LDLC is developed by Cozy Cloud and distributed under the [AGPL v3 license][agpl-3.0].
